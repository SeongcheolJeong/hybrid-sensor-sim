...
BLOCK_CATALOG: list[dict[str, Any]] = [
    ...
    {
        "block_id": "p_cloud_engine.control_plane_operator_surface",
        "project_id": "P_Cloud-Engine",
        "source_kind": "workflow_pattern",
        "source_paths": [
            "30_Projects/P_Cloud-Engine/prototype/cloud_batch_runner.py",
        ...
        "current_paths": [
            ...
            "apps/control-plane/postcss.config.cjs",
            "apps/control-plane/tailwind.config.ts",
            "apps/control-plane/tsconfig.app.json",
            "apps/control-plane/tsconfig.json",
            "apps/control-plane/tsconfig.node.json",
            "apps/control-plane/vite.config.ts",
            "apps/control-plane/src/components/app-shell.tsx",
            "apps/control-plane/src/components/data-table.tsx",
            "apps/control-plane/src/components/json-viewer.tsx",
            "apps/control-plane/src/components/metric-card.tsx",
            "apps/control-plane/src/components/panel.tsx",
            "apps/control-plane/src/components/run-launch-dialog.tsx",
            "apps/control-plane/src/components/status-bar-chart.tsx",
            "apps/control-plane/src/components/status-chip.tsx",
            "apps/control-plane/src/index.css",
            "apps/control-plane/src/lib/api.ts",
            "apps/control-plane/src/lib/defaults.ts",
            "apps/control-plane/src/lib/types.ts",
            "apps/control-plane/src/main.tsx",
            "apps/control-plane/src/pages/autoware-page.tsx",
            "apps/control-plane/src/pages/history-page.tsx",
            "apps/control-plane/src/pages/maps-page.tsx",
            "apps/control-plane/src/pages/projects-page.tsx",
            "apps/control-plane/src/pages/run-detail-page.tsx",
            "apps/control-plane/src/pages/runtime-page.tsx",
            "apps/control-plane/src/pages/simulation-page.tsx",
            "apps/control-plane/src/pages/validation-page.tsx",
            "apps/control-plane/src/pages/workspace-page.tsx",
            "apps/control-plane/src/router.tsx",
            "apps/control-plane/src/vite-env.d.ts",
        ],
        "current_test_paths": [],
        "current_fixture_paths": [],
        "current_script_paths": [],
        ...
        "working_result_kind": ["workflow", "doc"],
        "result_summary": "Dark-first operator console for runs, runtime blockers, probes, and Autoware readiness layered on local APIs.",
        "open_gaps": [
            "No multi-user auth or remote deployment in the current round.",
            "CARLA remains a blocker surface until a runnable local runtime exists.",
        ],
        "notes": "This is an internal control plane, not a public marketing site.",
    },
    {
    ...
    {
        "block_id": "p_e2e_stack.control_plane_api",
        "project_id": "P_E2E_Stack",
        "source_kind": "workflow_pattern",
        "source_paths": [
            "30_Projects/P_E2E_Stack/prototype/compare_runtime_evidence.py",
        ...
        "migration_status": "partial",
        "current_paths": [
            "src/hybrid_sensor_sim/server/__init__.py",
            "src/hybrid_sensor_sim/server/app.py",
            "src/hybrid_sensor_sim/server/db.py",
            "src/hybrid_sensor_sim/server/jobs.py",
            "src/hybrid_sensor_sim/server/models.py",
            "src/hybrid_sensor_sim/server/routes/__init__.py",
            "src/hybrid_sensor_sim/server/routes/autoware.py",
            "src/hybrid_sensor_sim/server/routes/history.py",
            "src/hybrid_sensor_sim/server/routes/projects.py",
            "src/hybrid_sensor_sim/server/routes/runs.py",
            "src/hybrid_sensor_sim/server/routes/runtime.py",
            "src/hybrid_sensor_sim/server/routes/scenarios.py",
        ],
        "current_test_paths": [
        ...
        "current_fixture_paths": [],
        "current_script_paths": [
            "scripts/run_control_plane_api.py",
        ],
        "current_doc_paths": [
            "README.md",
            "docs/architecture_guide.md",
        ...
        "working_result_kind": ["library", "workflow", "cli", "test", "doc"],
        "result_summary": "FastAPI control-plane API and local job/index layer over the existing runtime, probe, and Autoware workflows.",
        "open_gaps": [
