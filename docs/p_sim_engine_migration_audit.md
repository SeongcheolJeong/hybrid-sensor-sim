...
1. deeper map-aware behavior beyond lane-id normalization, lane-binding inference, route synthesis, route-aware runtime path-conflict handling, route summary wiring, and route-aware lane-risk aggregation
